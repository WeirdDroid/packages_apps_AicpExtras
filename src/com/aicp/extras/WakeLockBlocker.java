...
public class WakeLockBlocker extends BaseSettingsFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mBlockerEnabled = (Switch) getView().findViewById(
                R.id.wakelock_blocker_switch);
        mWakeLockList = (ListView) getView().findViewById(
                R.id.wakelock_list);
        mWakeLockListHeader = (TextView) getView().findViewById(
